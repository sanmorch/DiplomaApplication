...
public class SubjectListAdapter extends RecyclerView.Adapter<SubjectListAdapter.CourseListViewHolder> {
    ...
    public SubjectListAdapter(OnItemClickedListener onItemClickedListener) {
